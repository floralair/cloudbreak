...
public class CredentialController implements CredentialEndpoint {
    ...
    public CredentialResponse getPrivate(@PathParam("name") String name) {
        CbUser user = authenticatedUserService.getCbUser();
        MDCBuilder.buildUserMdcContext(user);
    ...
    public CredentialResponse getPublic(@PathParam("name") String name) {
        CbUser user = authenticatedUserService.getCbUser();
        MDCBuilder.buildUserMdcContext(user);
    ...
    public CredentialResponse get(@PathParam("id") Long id) {
        CbUser user = authenticatedUserService.getCbUser();
        MDCBuilder.buildUserMdcContext(user);
    ...
    public CredentialResponse deletePublic(@PathParam("name") String name) {
        CbUser user = authenticatedUserService.getCbUser();
        MDCBuilder.buildUserMdcContext(user);
    ...
    @Override
    public CredentialResponse deletePrivate(@PathParam("name") String name) {
        CbUser user = authenticatedUserService.getCbUser();
        MDCBuilder.buildUserMdcContext(user);
        credentialService.delete(name, user);
        return new CredentialResponse();
